...
//    cargoStatus = document.getElementById("cargoStatus");
    ...
    if(cargoLevel===fuelLevel && fuelLevel < CargoLevel ){
    if (  validateInput(Number(pilot)) === "Empty" ||  validateInput(Number(copilot)) === "Empty" ||  validateInput(Number(fuelLevel)) === "Empty" ||  validateInput(Number(cargoLevel)) === "Empty") {
           ...
           } else if (  validateInput(Number(pilot)) === "Is a Number" ||  validateInput(Number(copilot)) === "Is a Number" ||  validateInput(Number(fuelLevel)) === "Not a Number" ||  validateInput(Number(cargoLevel)) === "Not a Number" ) {
            ...
            //  let launchStatus = document.getElementById("launchStatus");
                ...
                //         pilotStatus.innerHTML =`Pilot NOT Ready (${pilot.value})`;
                // }else if (validateInput(copilot)==="Empty"||validateInput(copilot)==="Not a Number"){
                //          pilotStatus.innerHTML = `CoPilot NOT Ready (${copilot.value})`;
                // }else
